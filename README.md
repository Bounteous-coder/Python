This project is a simple PC shop simulation implemented in Python, where users can either build a custom PC by selecting individual components or purchase a pre-built PC from a predefined list.
